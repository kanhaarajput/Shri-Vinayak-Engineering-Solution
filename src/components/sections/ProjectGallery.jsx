            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${
                activeCategory === category
                  ? 'bg-amber-500 text-gray-950 shadow-[0_0_20px_rgba(245,158,11,0.4)] scale-105'
          ...
          <AnimatePresence>
            {filteredProjects.map((project) => (
              <motion.div
                ...
                key={project.id}
                className="group relative rounded-2xl overflow-hidden cursor-pointer aspect-square bg-gray-900 border border-white/5"
        ...
        <AnimatePresence>
          {selectedImage && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/95 backdrop-blur-xl p-4 sm:p-8"
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-3">
                  ...
                  <div className="p-8 lg:p-10 flex flex-col justify-center bg-gradient-to-br from-gray-900 to-gray-950">
                    <span className="inline-block px-3 py-1 bg-amber-500/10 text-amber-400 rounded-full text-xs font-bold uppercase tracking-wider mb-4 w-fit">
